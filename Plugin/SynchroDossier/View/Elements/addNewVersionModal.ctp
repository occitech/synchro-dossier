<div id="addNewVersion" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-header">
		...
		<h3 id="myModalLabel"><?= __d('SynchroDossier', 'Ajoutez une nouvelle version de'); ?><span class="filename"></span></h3>
	</div>
	...
	<div class="modal-footer">
		<?= $this->Form->submit(__d('SynchroDossier', 'Ajoutez une nouvelle version'), array('class' => 'btn')); ?>
		<?= $this->Form->end(); ?>
	</div>
</div>
